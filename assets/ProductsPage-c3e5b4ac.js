...
`,ji=({closeModallAddProductForm:n,onClick:t,productTitle:r,calories:o,productId:e})=>{const a=ke(),u=re(Cn),[l,i]=p.useState({product:"",date:"",amount:"",calories:""}),[s,c]=p.useState(""),[d,f]=p.useState(""),[v,b]=p.useState(!1),h=Sn(new Date),g=r[0].toUpperCase()+r.slice(1).toLowerCase(),D=async A=>{if(A.preventDefault(),(0>=l.amount||3e3<=l.amount)&&l.amount)f("Entering value must be at range 1g to 3000g"),b(!0),c(o);else if(Object.keys(l).length<0||l.amount==="")f("Enter amount*"),b(!0);else if(u){Ae.error("Sorry, something went wrong, please try again",{theme:"dark"});return}else{f(""),b(!1);try{n(),t(l.calories),await a(nn(l))}catch{Ae.error("Sorry, something went wrong, please try again",{theme:"dark"})}}},I=A=>{const M=parseFloat(A.target.value),C=parseFloat(o);if(!isNaN(M)&&!isNaN(C)){const F=Math.round(M*C/100);c(F),i({productId:e,date:h,amount:M,calories:F}),f(""),b(!1)}else c(o),i({productId:"",date:"",amount:"",calories:""})};return m.jsxs(Ai,{onSubmit:D,noValidate:!0,children:[m.jsxs(Mi,{children:[m.jsx(Pi,{children:g}),m.jsxs(Vi,{children:[m.jsx(Li,{htmlFor:"calories",children:"grams"}),m.jsx(ki,{type:"number",name:"calories",placeholder:"100",autoComplete:"off",required:!0,step:"1",min:"1",max:"3000",onChange:I}),v&&m.jsxs(Ri,{children:[m.jsx("svg",{children:m.jsx("use",{href:_+"#icon-checkbox-circle-fill"})}),d]})]})]}),s?m.jsxs(ht,{children:[m.jsx("span",{children:"Calories: "}),s]}):m.jsxs(ht,{children:[m.jsx("span",{children:"Calories: "}),o]}),m.jsxs(Ti,{children:[m.jsx($i,{type:"submit",children:"Add to diary"}),m.jsx(Bi,{type:"button",onClick:()=>{n()},children:"Cancel"})]})]})},Hi=({product:n,type:t,handleOpenModal:r})=>{const o=d=>[...d.map(f=>f[0].toUpperCase()+f.slice(1).toLowerCase())],{title:e,category:a,calories:u,weight:l}=n,i=o([e])[0],s=o([a])[0];let c;return t?c="Recommended":c="Not recommended",m.jsxs(rn,{children:[m.jsx(on,{children:"DIET"}),m.jsxs("div",{style:{display:"flex",gap:"16px",alignSelf:"flex-end",flexWrap:"wrap"},children:[m.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[m.jsx(_e,{children:t?m.jsx("use",{href:_+"#icon-Ellipse-82",style:{fill:E.colorSecondaryGreen,stroke:E.colorSecondaryGreen}}):m.jsx("use",{href:_+"#icon-Ellipse-82",style:{fill:E.colorSecondaryRed,stroke:E.colorSecondaryRed}})}),m.jsx(Ce,{children:c})]}),m.jsxs(an,{onClick:()=>r(n),children:["Add",m.jsx(_e,{style:{width:"16px",height:"16px"},children:m.jsx("use",{href:_+"#icon-arrow",style:{stroke:E.colorOrange}})})]})]}),m.jsxs(un,{children:[m.jsx("svg",{style:{flexShrink:0,width:"24px",height:"24px"},children:m.jsx("use",{href:_+"#icon-running-stick-figure-svgrepo-com-1"})}),m.jsx(sn,{children:i})]}),m.jsxs(ln,{children:[m.jsxs(Ce,{children:[m.jsx("span",{children:"Calories:"}),u]}),m.jsxs(cn,{children:[m.jsx("span",{children:"Category:"}),s]}),m.jsxs(Ce,{children:[m.jsx("span",{children:"Weight:"}),l]})]})]})},Wi=n=>n.products.productsArray,Ni=n=>n.products.productsCategories,Ut=n=>n.products.isLoadingProducts,Ui=P.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`,Yi=({products:n})=>{const t=re(Ut),[r,o]=p.useState(null),[e,a]=p.useState(!1),[u,l]=p.useState(null),i=f=>{a(!0),o(f),l(f)},s=()=>{e&&a(!1),o(null),l(null)},d=re(dn).blood;return m.jsxs(m.Fragment,{children:[t&&m.jsx(Le,{}),!t&&n.length>0&&m.jsx(Ui,{children:n.map(f=>m.jsx(Hi,{product:f,type:f.groupBloodNotAllowed[d],handleOpenModal:i},f._id))}),!t&&n.length<=0&&m.jsxs(zi,{children:[m.jsxs(_i,{children:[m.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),m.jsx(Gi,{children:"Try changing the search parameters."})]}),r&&m.jsx(Ei,{isOpen:e,onRequestClose:s,children:typeof u=="object"?m.jsx(ji,{closeModallAddProductForm:s,calories:r.calories,productTitle:r.title,productId:r._id,product:u,onClick:i}):m.jsx(Ii,{calories:u,closeModalAddProductSuccess:s})})]})},qi="/fs-86-react-node-NikNas1405/assets/products-bg-b7e77cea.jpg",Xi="/fs-86-react-node-NikNas1405/assets/products-bg@2x-9876be0a.jpg",Ki=P.div`
  display: flex;
  flex-direction: column;
  gap: 40px;
  height: 100vh;
